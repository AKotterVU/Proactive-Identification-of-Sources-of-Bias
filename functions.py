...
def resamp_disparity(name, X_in, y_in, dem_cols=["GENDER", "RACE"], 
    ...
    by a combination of SMOTE and random undersampling. If 'sdoh' is a 
    list instead of a string, then the data are resampled based on all 
    of the columns in 'sdoh'. The model is not trained on any data in 
    'dem_cols'.
    Hyperparameter optimizer optimizes for the first entry of 
    'score_funcs'.
